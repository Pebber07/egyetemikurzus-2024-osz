...
public class PlayerWinRateListerTests
{
    ...
    public void SetUp()
    {
        games = new List<Game>
        {
            new Game("Tapodi, Norman Lajos", "Valaki", 2108, 2000, "1-0", "C54", "Tournament1", new DateTime(2023, 5, 1), "e4 e5...", 30), //Todo: itt A54 vagy kiralycsel
            new Game("Tapodi, Norman Lajos", "Valaki1", 2112, 2200, "1/2-1/2", "B23", "Tournament2", new DateTime(2023, 6, 1), "e4 c5...", 40),
            new Game("Player4", "Tapodi, Norman Lajos", 2200, 2400, "0-1", "A45", "Tournament3", new DateTime(2023, 7, 1), "d4 Nf6...", 50)
        };
    }
